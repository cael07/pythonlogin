  ...
  <div class="auth-page">
    <div class="auth-card-wide glass" style="padding: 2.5rem;">
      ...
      <div class="auth-header">
        ...
        <h1 class="auth-title">{{ step === 1 ? 'Driver Portal' : 'Face Verification' }}</h1>
        <p class="auth-subtitle">{{ step === 1 ? 'Sign in to your driver account' : 'Verify your identity to continue' }}</p>
      </div>
