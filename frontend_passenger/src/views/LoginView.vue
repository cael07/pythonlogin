  ...
  <div class="auth-page">
    <div class="auth-card-wide glass" style="padding: 2.5rem;">
      ...
      <div class="auth-header">
        ...
        <h1 class="auth-title">{{ step === 1 ? 'Passenger Portal' : 'Face Verification' }}</h1>
        <p class="auth-subtitle">{{ step === 1 ? 'Sign in to book your ride' : 'Verify your identity to continue' }}</p>
      </div>
...
async function handleLogin() {
  ...
  try {
    ...
    const redirect = route.query.redirect || '/passenger'
